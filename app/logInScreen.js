...
export default function LoginScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.fundal }]}>
      <View style={[styles.containerLogIn, { backgroundColor: theme.card, borderColor: theme.bordura }]}>
        <Text style={[styles.logInHeader, { color: theme.accent }]}>Welcome</Text>
        <Text style={[styles.logInSubHeader, { color: theme.textSecundar }]}>Log in to your account</Text>
        <TextInput 
        ...
        <TouchableOpacity style={[styles.logInButton, { backgroundColor: theme.accent }]} onPress={handleLogin}>
          <Text style={[styles.logInButtonText, { color: theme.fundal }]}>Log In</Text>
        </TouchableOpacity>
      </View>
      <View style={styles.containerSignUp}>
        <Text style={{color: theme.textSecundar}}>Don't have an account?</Text>
